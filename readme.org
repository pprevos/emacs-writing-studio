...
This repository contains the Org mode source files for the /Emacs Writing Studio/ book. The source files are optimised for PDF (using LaTeX), ePub and word processor file (ODT or DOCx).

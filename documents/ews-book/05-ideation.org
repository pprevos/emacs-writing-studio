...
You can also add citations to your bibliographic and other notes. For a detailed description on how to insert citations into Org mode files, read section [[#sec:citations]] in the next chapter.
...
Viewing your notes as a network can help discover hitherto unseen connections between your thoughts. Visualising your Denote digital garden as a network can be helpful in your creative process. A network diagram has nodes (vertices) and edges. Each node represents a file in your Denote system, and each edge is a link between notes  (figure [[fig:network]]).

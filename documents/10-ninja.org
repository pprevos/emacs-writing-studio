...
This is a brief overview of some alternative packages you could be using. The ~list-packages~ command provides a useful interface to the list of all available packages. You can explore this interface to find interesting software or update your existing system.

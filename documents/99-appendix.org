...
The ~consult-theme~ command invoke the consult package to help you select between installed themes. To set a default theme, run the ~customize-themes~ command and select your preferred version. Click the button to store your chosen default in the =custom.el= file.
